...
Given('En la pagina de suma', async function(){
...
When('Ingresamos el primer valor para sumar {string}', async function (valor1){
...
When('Ingresamos el segundo valor para sumar {string}', async function (valor2) { 
...
When('Realizamos click en el boton sumar', async function () {
...
Then('Muestra el valor sumado', async function(){
